...
\begin{definition}\label{def:operation-galois}
  ...
  Equivalently:
  \[
    F_{D^\#}(a_1,..., a_i, ..., a_n) =  \alpha_{D^\#}(\{F(c_1,..., c_i, ..., c_n) | 1 \le i \le n, c_i \in \gamma_{D^\#}(a_i)\})
  \]
\end{definition}
